...
export function normalizePlayer(player = {}, index = 0) {
  ...
  return {
    ...
    coins: score,
    score,
    visualPosition: normalizeLayoutPosition(player.visualPosition || player.layoutPosition || player.tablePosition || player.seatPosition),
    layoutPosition: normalizeLayoutPosition(player.layoutPosition || player.visualPosition || player.tablePosition || player.seatPosition),
    position: normalizeLayoutPosition(player.visualPosition || player.layoutPosition || player.tablePosition || player.seatPosition || player.position) || fallbackPositions[index] || 'bottom',
...
export function normalizeGameState(response = {}) {
  ...
  return {
    ...
    turnOrder: state.turnOrder || safeResponse.turnOrder || [],
    visualSeatMap: state.visualSeatMap || safeResponse.visualSeatMap || {},
    ...
    startingPlayerId: state.startingPlayerId || state.turnPlayerId || state.dealerUserId || safeResponse.startingPlayerId,
    dealerRolls: state.dealerRolls || state.diceRolls || safeResponse.dealerRolls || safeResponse.diceRolls || [],
    diceRolls: state.diceRolls || state.dealerRolls || safeResponse.diceRolls || safeResponse.dealerRolls || [],
    diceRollPhase: state.diceRollPhase || state.startPhase || safeResponse.diceRollPhase || null,
