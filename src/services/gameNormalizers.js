...
export function normalizeGameState(response = {}) {
  ...
  return {
    ...
    dealerRollRevealMs: state.dealerRollRevealMs || state.dealerRollReveal?.revealDurationMs || safeResponse.dealerRollRevealMs || safeResponse.dealerRollReveal?.revealDurationMs || 3000,
